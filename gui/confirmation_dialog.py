...
class ConfirmationDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.btn_yes.setStyleSheet(
            "background: #00D4FF; color: black; padding: 6px 16px; border-radius: 4px;"
        )
        self.btn_yes.clicked.connect(self._on_yes)

        self.btn_no = QPushButton("NO")
        self.btn_no.setStyleSheet(
            "background: transparent; color: #FF3355; border: 1px solid #FF3355; padding: 6px 16px; border-radius: 4px;"
        )
