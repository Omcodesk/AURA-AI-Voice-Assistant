...
class ActionRegistry:
    ...
    def __init__(self):
        ...
        self._registry: Dict[
            str, Dict[str, Callable[[ParsedCommand], ExecutionResult]]
        ] = {}
    ...
    def register(
        ...
        intent: str,
        action: str,
        handler: Callable[[ParsedCommand], ExecutionResult],
    ) -> None:
    ...
    def get_handler(
        self, intent: str, action: str
    ) -> Callable[[ParsedCommand], ExecutionResult] | None:
