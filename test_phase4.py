...
res1 = write_file(
    ParsedCommand(
        ...
        action="write_file",
        arguments={
            "filepath": "test_developer.txt",
            "content": "Hello AURA Developer!",
        },
    )
)
print(res1)
...
res2 = read_file(
    ParsedCommand(
        intent="developer",
        action="read_file",
        arguments={"filepath": "test_developer.txt"},
    )
)
print(res2)
...
res3 = run_command(
    ParsedCommand(
        intent="developer",
        action="run_command",
        arguments={"command": "echo 'Terminal Test Works'"},
    )
)
print(res3)
...
res4 = run_command(
    ParsedCommand(
        intent="developer",
        action="run_command",
        arguments={"command": "pip install fake-pkg"},
    )
)
print(res4)
